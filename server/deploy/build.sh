...
GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go run github.com/caddyserver/xcaddy/cmd/xcaddy@v0.4.5 build v2.11.4 --with github.com/caddy-dns/cloudflare@v0.2.2 --output "$artifact/caddy"
